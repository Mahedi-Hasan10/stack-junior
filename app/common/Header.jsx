...
const Header = () => {
  ...
  return (
    <header className=" relative flex lg:gap-[107px] md:gap-[50px] gap-[40px] justify-between lg:px-[86px] md:px-[70px] px-[30px] py-[40px] text-white bg-[#0063a4]">
      {/* logo */}
      ...
      <div className="lg:flex gap-[60px] md:hidden hidden">
        <nav className="flex gap-[60px] text-base items-center justify-center">
          ...
          <Link href="/">Quick Tutorials</Link>
        </nav>
      ...
      {showMenu && (
        <div className="flex flex-col py-5 space-y-3 gap-[40px] w-[100%] transition duration-300 absolute top-[127px] left-0 bg-[#0063a4] bg-opacity-80 text-base justify-start items-center">
          <Link className="font-bold mt-2" href="/">
            Courses
          </Link>
          <Link href="/">About StackJunior</Link>
          <Link href="/">Quick Tutorials</Link>
