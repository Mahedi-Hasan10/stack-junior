    ...
    return (
        <div className='bg-[#FEEFDC] '>
           <div className='mx-auto text-center lg:pt-[170px] md:pt-[120px] pt-[60px] lg:px-[104px] px-[40px]'>
               ...
               <input type="search" placeholder='what are you looking for ?' className='lg:w-[870px] lg:h-[63px] shadow-sm px-[40px] py-[10px]'/> <button className="lg:w-[95px] lg:h-[63px] py-[10px] px-[10px] rounded-md bg-[#FF0B80] lg:text-[40px] text-[23px] flex items-center justify-center text-white"><IoSearch/></button>
               </div>
        ...
        <h2 className='text-[36px] text-[#2b2b2b] py-4 font-bold mb-3 ml-2 text-center pt-6'>Checkout our courses</h2>
