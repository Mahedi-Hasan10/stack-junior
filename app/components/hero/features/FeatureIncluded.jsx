...
const FeatureIncluded = () => {
    return (
        <section className='min-h-[100vh] lg:mt-[270px] lg:px-[104px] px-[40px] pb-[100px]'>
            <h2 className='text-[36px] text-[#2b2b2b] font-bold mb-3 ml-2'>Feature Included</h2>
...
export default FeatureIncluded;